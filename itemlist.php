...
$sql = "INSERT INTO `item_list` (`srno`, `item_name`, `item_price`, `item_labour`, `hsn_sac_code`) VALUES (NULL, '".$_POST['itemname']."', '".$_POST['itemprice']."', '".$_POST['itemlabour']."', '".$_POST["hsn_sac_code"]."');";
if(isset($_POST['itemno'])){
    $sql = "DELETE FROM  item_list WHERE srno=".$_POST['itemno'];
    $conn->query($sql);
    $sql = "INSERT INTO `item_list` (`srno`, `item_name`, `item_price`, `item_labour`, `hsn_sac_code`) VALUES (".$_POST['itemno'].", '".$_POST['itemname']."', '".$_POST['itemprice']."', '".$_POST['itemlabour']."', '".$_POST["hsn_sac_code"]."');";
}
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post">
            ...
            <div class="form-group">
                <label for="itemlabour">HSN/SAC:</label>
                <input type="text" class="form-control" id="itemlabour" value="<?=$row["hsn_sac_code"]?>" name="hsn_sac_code">
            </div>
            <div class="form-group">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post">
            ...
            <div class="form-group">
                <label for="itemlabour">HSN/SAC:</label>
                <input type="text" class="form-control" id="itemlabour" value="" name="hsn_sac_code">
            </div>
            <div class="form-group">
                <button class="btn btn-info">Submit</button>
            </div>
