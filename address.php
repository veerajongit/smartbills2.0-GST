...
$sql = "INSERT INTO `address` (`srno`, `companyname`, `address`, `creationdate`, `gstno`) VALUES (NULL, '".$_POST['company']."', '".$_POST['address']."', CURRENT_TIMESTAMP, ".$_POST["gstno"].");";
if(isset($_POST['srno'])){
    $sql = "DELETE FROM  address WHERE srno=".$_POST['srno'];
    $conn->query($sql);
    $sql = "INSERT INTO `address` (`srno`, `companyname`, `address`, `creationdate`, `gstno`) VALUES (".$_POST['srno'].", '".addslashes($_POST['company'])."', '".addslashes($_POST['address'])."', CURRENT_TIMESTAMP, '".$_POST["gstno"]."');";
}
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="gstno" value="<?=$row['gstno']?>" name="gstno" required>
            </div>
            <div class="form-group">
